...
export default function VelourHeader() {
    ...
    return (
        <>
            {/* Top Bar */}
            <div style={{ background: "var(--gold-gradient)", color: "#01141A", padding: "8px 40px", display: "flex", justifyContent: "space-between", alignItems: "center", fontSize: "12px", fontWeight: "600", letterSpacing: "0.05em", zIndex: 1001, position: "absolute", top: 0, left: 0, right: 0 }} className="vh-topbar">
