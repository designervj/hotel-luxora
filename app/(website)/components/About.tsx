...
export default function About() {
  return (
    <section id="about" style={{ padding: "112px 0", overflow: "hidden" }}>
        ...
        <div>
          ...
          <div className="about-text" style={{ fontSize: "1.05rem", lineHeight: "1.8", color: "#a0a0a0" }}>
            <p className="fade-in-up visible" style={{ marginBottom: "20px" }}>
              Hotel Luxora is a <strong style={{ color: "var(--gold)" }}>value-for-money hotel</strong> offering clean, well-furnished rooms tailored for both business travelers and tourists. Each room is thoughtfully equipped with essentials such as <strong style={{ color: "var(--gold)" }}>air conditioning, private bathrooms, comfortable chairs, work desks, telephones, televisions</strong>, and <strong style={{ color: "var(--gold)" }}>24/7 hot and cold water supply</strong>—everything you need for a <strong style={{ color: "var(--gold)" }}>comfortable yet affordable stay</strong>.
            </p>
            <p className="fade-in-up visible">
              Located near <strong style={{ color: "var(--gold)" }}>JECC</strong>, major <strong style={{ color: "var(--gold)" }}>transport hubs</strong>, and <strong style={{ color: "var(--gold)" }}>local food joints</strong>, our hotel is perfect for <strong style={{ color: "var(--gold)" }}>budget-conscious travelers</strong> seeking convenience and accessibility. With a focus on <strong style={{ color: "var(--gold)" }}>cleanliness, functionality</strong>, and <strong style={{ color: "var(--gold)" }}>friendly service</strong>, Hotel Luxora is the ideal pick for <strong style={{ color: "var(--gold)" }}>short or extended stays</strong> in Jaipur's Sitapura Industrial Area.
            </p>
          </div>
        </div>
      </div>
