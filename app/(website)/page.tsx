...
function HeroRenderer({ sec }: { sec: HeroSection }) {
    ...
    const images = sec.images?.length > 0
        ...
        : [
            ...
            { url: "https://images.unsplash.com/photo-1566404791732-26150b0cd07f?auto=format&fit=crop&q=80" },
            { url: "https://images.unsplash.com/photo-1544644181-1484b3fdfc62?auto=format&fit=crop&q=80" }
          ];
            ...
            <div className="hero-inner">
                <div className="hero-content fade-in-up visible">
                    <div className="hero-eyebrow">
                        ...
                        <span className="eyebrow-text">WELCOME TO HOTEL LUXORA</span>
                    </div>
...
export default function HomePage() {
    ...
    return (
        <>
            ...
            {testimSections.length === 0 && <Testimonials />}
            <Contact />
        </>
    );
}
