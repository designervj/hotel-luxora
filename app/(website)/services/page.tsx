            ...
            <div className="max-w">
                ...
                <div style={{ textAlign: "center", marginBottom: 80 }}>
                    ...
                    <p className="fade-in-up" style={{ color: "var(--ivory-dim)", marginTop: 24, fontSize: 15, maxWidth: 600, margin: "24px auto 0", lineHeight: 1.8 }}>
                        At Hotel Luxora, we believe that true luxury lies in the quiet perfection of every detail. Our curated services are designed to offer you an unparalleled retreat.
                    </p>
                </div>
