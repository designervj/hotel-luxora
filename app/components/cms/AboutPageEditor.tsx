        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 14 }}>
            ...
            <div>
                ...
                <textarea value={sec.text} onChange={e => onChange({ ...sec, text: e.target.value })}
                    placeholder={`"We created Luxora as a love letter to Jaipur..."`}
...
const DEFAULT_SECTIONS: AboutSection[] = [
    {
        ...
        subheading: "",
        description: "Hotel Luxora is a value-for-money hotel offering clean, well-furnished rooms tailored for both business travelers and tourists. Each room is thoughtfully equipped with essentials such as air conditioning, private bathrooms, comfortable chairs, work desks, telephones, televisions, and 24/7 hot and cold water supply—everything you need for a comfortable yet affordable stay.\n\nLocated near JECC, major transport hubs, and local food joints, our hotel is perfect for budget-conscious travelers seeking convenience and accessibility. With a focus on cleanliness, functionality, and friendly service, Hotel Luxora is the ideal pick for short or extended stays in Jaipur's Sitapura Industrial Area.",
    ...
    },
    {
        ...
        type: "quote",
        eyebrow: "The Vision",
        text: "\"We created Luxora as a love letter to Jaipur — a space where guests don't just visit, they belong.\"",
    },
];
