    ...
    return (
        <footer className="bg-[#0f1623] text-gray-300 py-16">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-4 gap-12">
                <div className="col-span-1 md:col-span-2">
                    <div className="flex items-center gap-3 mb-6">
                        <img src={hotel?.logoUrl || "/luxora-white-logo.svg"} alt="Logo" className="h-10 w-auto opacity-80 mix-blend-lighten" />
                        <span className="font-serif font-bold text-xl tracking-wider text-white">
                            {hotel?.name || "HOTEL LUXORA"}
                        </span>
                    </div>
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-16 pt-8 border-t border-gray-800 text-sm text-center text-gray-500 flex flex-col md:flex-row justify-between items-center">
                <p>&copy; {new Date().getFullYear()} {hotel?.name || "Hotel Luxora"}. All rights reserved.<br />Developed By <a href="https://www.codifiedwebsolutions.com/" target="_blank" rel="noopener noreferrer">Codified Web Solutions</a></p>
