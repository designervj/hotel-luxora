...
const MONGODB_DB = mongoDbMatch ? mongoDbMatch[1].trim().replace(/^"|"$/g, '') : "kp_hotel_luxora";
...
const LEGAL_PAGES = [
    {
        ...
        slug: "privacy-policy",
        content: "<h1>Privacy Policy</h1><p>At Hotel Luxora, we are committed to protecting your privacy. This policy explains how we collect and use your data.</p><h3>Data Collection</h3><p>We collect information you provide directly to us when you make a booking, such as your name, email address, and phone number.</p><h3>Use of Data</h3><p>Your data is used solely to facilitate your stay, process payments, and improve our services.</p>",
        isPublished: true,
    ...
    },
    {
        ...
        isPublished: true,
        metaTitle: "Terms of Service | Hotel Luxora",
        metaDescription: "Review the terms and conditions for staying at Hotel Luxora."
    }
];
