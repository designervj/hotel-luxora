# Hotel Luxora - Admin Panel & Property Management System (PMS)

## 1. Project Overview
Hotel Luxora is a comprehensive, modern web-based Property Management System (PMS) designed to streamline hotel operations. It provides staff and management with a centralized dashboard to manage bookings, guest profiles, room inventory, housekeeping, maintenance, and staff rosters. 
