...
const cmsPages = [
  {
    ...
    sections: [
      {
        ...
        description: "By accessing and using Hotel Luxora's services, you agree to be bound by these terms. If you do not agree, please refrain from using our website or booking services."
      },
      {
        id: "l2",
        type: "legal-block",
    ...
    content: [],
    metaTitle: "Terms & Conditions | Hotel Luxora",
    metaDescription: "Read the official terms and conditions for staying at Hotel Luxora, Jaipur.",
    createdAt: new Date().toISOString(),
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        description: "Hotel Luxora employs industry-standard security measures to protect your personal information from unauthorized access or disclosure."
      }
    ],
    content: [],
    metaTitle: "Privacy Policy | Hotel Luxora",
    metaDescription: "Learn how Hotel Luxora protects your personal information and stays compliant with data laws.",
    createdAt: new Date().toISOString(),
    updatedAt: new Date().toISOString()
  }
];
